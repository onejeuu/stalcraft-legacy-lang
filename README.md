...
Это сработает, если за время использования в игре не выходило патчей. Иначе резервная копия может оказаться устаревшей.

Резервные копии хранятся по пути `%USERNAME%/sclegacylang/backup`.
